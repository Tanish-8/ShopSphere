...
export const CategoryCard = ({ name, image, count, icon: Icon, index, className }: CategoryCardProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative h-[280px] w-full rounded-3xl overflow-hidden group cursor-pointer perspective-1000",
        className
      )}
    >
      {/* Glow Effect */}
      ...
      <div className="relative h-full w-full rounded-3xl overflow-hidden bg-zinc-900">
        ...
        {/* Card Content */}
        <div className="absolute inset-0 p-6 flex flex-col justify-end transform-gpu translate-z-20">
          <div className="flex items-center justify-between mb-2">
            ...
            <motion.div 
              ...
              className="px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-[10px] font-medium text-white/90 uppercase tracking-wider"
            >
              {count} Products
            </motion.div>
          </div>
