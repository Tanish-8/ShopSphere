...
export const CategorySection = () => {
  return (
    <section className="py-24 px-6 md:px-12 lg:px-20 bg-[#050505]">
      <div className="max-w-screen-2xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          >
            <button className="px-6 py-3 rounded-full bg-zinc-800 text-white font-medium hover:bg-zinc-700 transition-colors">
              View All Categories
            </button>
          </motion.div>
        </div>
