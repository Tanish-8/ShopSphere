...
const blobs: BlobConfig[] = [
  ...
  },
  {
    id: 2,
    className:
      "absolute top-1/2 -right-48 w-[500px] h-[500px] rounded-full bg-indigo-500/25 blur-[100px]",
  ...
  },
  {
    id: 3,
    className:
      "absolute bottom-0 left-1/3 w-[400px] h-[400px] rounded-full bg-purple-500/20 blur-[90px]",
